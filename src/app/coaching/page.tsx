    ...
    <>
      ...
      <section className="relative overflow-hidden" style={{ background: 'var(--color-ink)' }} aria-labelledby="hero-heading">
        ...
        <div className="max-w-[1200px] mx-auto px-[5%] py-16 grid grid-cols-1 md:grid-cols-2 gap-16 items-center relative z-10">
          <div className="fade-up-children flex flex-col">
            ...
            <p className="font-light mb-3" style={{ fontSize: '1rem', color: 'rgba(255,255,255,0.82)', lineHeight: 1.85, maxWidth: 500 }}>
              Most GTM teams train in silos and wonder why execution is inconsistent.
            </p>
            <p className="font-light mb-11" style={{ fontSize: '1rem', color: 'rgba(255,255,255,0.82)', lineHeight: 1.85, maxWidth: 500 }}>
            ...
            {heroStats.map((s, i) => (
              <div key={i} className="flex items-center gap-5 px-7 py-6" style={{ background: 'var(--color-linen)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 3 }}>
                ...
                <div>
                  ...
                  <p className="font-light" style={{ fontSize: '0.84rem', color: 'var(--color-sage)', lineHeight: 1.6 }}>{s.sub}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section style={{ background: 'var(--color-white)' }} aria-labelledby="for-heading">
        <div className="max-w-[1200px] mx-auto px-[5%] py-16">
          <span className="inline-block text-[0.7rem] tracking-[0.18em] uppercase font-medium px-3 py-1 rounded-full mb-5" style={{ color: 'var(--color-red)', background: 'var(--color-red-light)', border: '1px solid var(--color-red-mid)' }}>Outcomes by Function</span>
          ...
          <p className="font-light mb-12" style={{ fontSize: '0.95rem', color: 'var(--color-sage)', lineHeight: 1.8, maxWidth: 580 }}>
          ...
          <div className="mt-5 px-8 py-6 rounded-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-6" style={{ background: 'var(--color-sage)' }}>
            <div>
              <div className="text-[0.7rem] tracking-[0.18em] uppercase font-medium mb-1.5" style={{ color: 'rgba(255,255,255,0.6)' }}>Your GTM team's outcome</div>
      ...
      <section style={{ background: 'var(--color-ink)' }} aria-labelledby="problem-heading">
        <div className="max-w-[1200px] mx-auto px-[5%] py-16">
          <span className="inline-block text-[0.7rem] tracking-[0.18em] uppercase font-medium px-3 py-1 rounded-full mb-5" style={{ color: 'rgba(255,255,255,0.9)', background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.15)' }}>Why Training Fails</span>
          ...
          <div className="mt-12 pt-10 flex flex-col items-center text-center gap-6" style={{ borderTop: '1px solid rgba(255,255,255,0.1)' }}>
            ...
            <p className="font-light" style={{ fontSize: '0.82rem', color: 'rgba(255,255,255,0.45)' }}>Jonathan Corrie, CEO, Precursive</p>
      ...
      <section style={{ background: 'var(--color-linen)' }} id="system" aria-labelledby="system-heading">
        <div className="max-w-[1200px] mx-auto px-[5%] py-16">
          <span className="inline-block text-[0.7rem] tracking-[0.18em] uppercase font-medium px-3 py-1 rounded-full mb-5" style={{ color: 'var(--color-red)', background: 'var(--color-red-light)', border: '1px solid var(--color-red-mid)' }}>The Decision Confidence Operating System</span>
          ...
          <p className="font-light mb-10" style={{ fontSize: '0.95rem', color: 'var(--color-sage)', lineHeight: 1.8, maxWidth: 580 }}>
      ...
      <section style={{ background: 'var(--color-white)' }} id="how" aria-labelledby="expect-heading">
        <div className="max-w-[1200px] mx-auto px-[5%] py-16">
          <span className="inline-block text-[0.7rem] tracking-[0.18em] uppercase font-medium px-3 py-1 rounded-full mb-5" style={{ color: 'var(--color-red)', background: 'var(--color-red-light)', border: '1px solid var(--color-red-mid)' }}>What to Expect</span>
      ...
      <section style={{ background: 'var(--color-ink)' }} aria-labelledby="roi-heading">
        <div className="max-w-[1200px] mx-auto px-[5%] py-16 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div>
            <span className="inline-block text-[0.7rem] tracking-[0.18em] uppercase font-medium px-3 py-1 rounded-full mb-5" style={{ color: 'rgba(255,255,255,0.9)', background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.15)' }}>The Investment</span>
            ...
            <p className="font-light mb-4" style={{ fontSize: '0.95rem', color: 'rgba(255,255,255,0.82)', lineHeight: 1.85 }}>
            ...
            <p className="font-light" style={{ fontSize: '0.95rem', color: 'rgba(255,255,255,0.82)', lineHeight: 1.85 }}>
            ...
            {roiCards.map((c, i) => (
              <div key={i} className="flex gap-5 items-start p-8 rounded-sm" style={{ background: 'var(--color-linen)', border: '1px solid rgba(255,255,255,0.07)' }}>
                ...
                <div>
                  ...
                  <p className="font-light" style={{ fontSize: '0.84rem', color: 'var(--color-sage)', lineHeight: 1.7 }}>{c.body}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="overflow-hidden rounded-sm" style={{ background: 'var(--color-white)', border: '1px solid rgba(26,26,26,0.1)' }}>
            <div className="px-10 py-7 flex flex-col md:flex-row items-start md:items-center justify-between gap-6" style={{ background: 'var(--color-sage)' }}>
              <div>
                ...
                <p className="font-light" style={{ fontSize: '0.82rem', color: 'rgba(255,255,255,0.65)' }}>Professional Services Automation &nbsp;&bull;&nbsp; UK & United States</p>
              </div>
            ...
            <div className="p-10 grid grid-cols-1 md:grid-cols-2 gap-12">
              <div>
                ...
                <p className="font-light mb-4" style={{ fontSize: '0.92rem', color: 'var(--color-sage)', lineHeight: 1.8 }}>
                ...
                <p className="font-light italic" style={{ fontSize: '0.92rem', color: 'var(--color-sage)', lineHeight: 1.8 }}>
              ...
              <div>
                <h4 className="text-[0.7rem] tracking-[0.18em] uppercase font-medium mb-4" style={{ color: 'var(--color-red)' }}>What Changed</h4>
                {[
                  ...
                  <div key={i} className="flex items-start gap-3 mb-3">
                    ...
                    <p className="font-light" style={{ fontSize: '0.88rem', color: 'var(--color-sage)', lineHeight: 1.65 }}>
            ...
            <div className="mx-10 mb-10 pt-9" style={{ borderTop: '1px solid rgba(26,26,26,0.1)' }}>
              ...
              <div className="pl-5">
                ...
                <span className="font-light" style={{ fontSize: '0.78rem', color: 'var(--color-sage)' }}>CEO, Precursive</span>
              </div>
            </div>
          </div>
        </div>
