    ...
    <footer style={{ background: 'var(--color-ink)' }}>
      <div className="max-w-[1200px] mx-auto px-[5%] pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1.5fr_1fr_1fr_1fr] gap-12 pb-12" style={{ borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
          ...
          <div className="flex flex-col gap-5">
            ...
            <a
              ...
              style={{ color: 'rgba(255,255,255,0.4)', fontSize: '0.72rem', letterSpacing: '0.14em', textTransform: 'uppercase', fontWeight: 500 }}
              ...
              {services.map(s => (
                <li key={s.label}>
                  {s.active ? (
                    ...
                    <span className="font-light cursor-default" style={{ fontSize: '0.88rem', color: 'rgba(255,255,255,0.25)' }}>
                      {s.label}
                    </span>
                  )}
                </li>
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 pt-8">
          <p className="font-light" style={{ fontSize: '0.78rem', color: 'rgba(255,255,255,0.25)' }}>
            GTM Solutions Consulting &copy; {new Date().getFullYear()}
          </p>
          <div className="flex gap-6">
            <Link href="/impressum" className="font-light transition-colors" style={{ fontSize: '0.78rem', color: 'rgba(255,255,255,0.25)', letterSpacing: '0.1em', textTransform: 'uppercase' }}
              onMouseEnter={e => (e.currentTarget.style.color = 'rgba(255,255,255,0.5)')}
              onMouseLeave={e => (e.currentTarget.style.color = 'rgba(255,255,255,0.25)')}
            >
              Impressum
            </Link>
            <Link href="/privacy" className="font-light transition-colors" style={{ fontSize: '0.78rem', color: 'rgba(255,255,255,0.25)', letterSpacing: '0.1em', textTransform: 'uppercase' }}
              onMouseEnter={e => (e.currentTarget.style.color = 'rgba(255,255,255,0.5)')}
              onMouseLeave={e => (e.currentTarget.style.color = 'rgba(255,255,255,0.25)')}
            >
              Privacy
